...
var randomUrl0 = document.querySelector(".randomMeal-link0");
var randomUrl1 = document.querySelector(".randomMeal-link1");
var randomUrl2 = document.querySelector(".randomMeal-link2");
var randomUrl3 = document.querySelector(".randomMeal-link3");
var randomUrl4 = document.querySelector(".randomMeal-link4");
  ...
  fetch(requestUrl)
    ...
    .then(function (data) {
      for (var i = 0; i < 5; i++) {
        ...
        popularUrl[i].href = "mealstats.html?id=" + data.meals[i].idMeal;
      }
    });
}
...
function getRandomIngredients() {
  ...
  fetch(requestUrl)
    ...
    .then(function (data) {
      for (var i = 0; i < 5; i++) {
        popularIng[i].src = "https://www.themealdb.com/images/ingredients/" + data.meals[i].strIngredient + ".png";
        randomIngTxt[i].textContent = data.meals[i].strIngredient;
        ingredientUrl[i].href = "search.html?filter=ingredients&i=" + data.meals[i].strIngredient;
      }
    });
}
